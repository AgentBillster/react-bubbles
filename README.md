...
- [ ] Explain what a token is used for. for authentication
- [ ] What steps can you take in your web apps to keep your data secure? implement private routes
- [ ] Describe how web servers work. a server uses http and different protocols to respond to client requests
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. post, get, put, delete??
